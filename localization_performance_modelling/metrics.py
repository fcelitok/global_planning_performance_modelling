...
from performance_modelling_py.visualisation.trajectory_visualisation import save_trajectories_plot, save_trajectories_with_covariance_plot
...
def compute_metrics(run_output_folder):
    ...
    print_info("save_trajectories_with_covariance_plot")
    save_trajectories_with_covariance_plot(visualisation_output_folder, estimated_poses_path, estimated_correction_poses_path, ground_truth_poses_path)
