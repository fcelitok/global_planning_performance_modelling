...
from global_planning_performance_modelling.global_planning_benchmark_run import BenchmarkRun
...
def main():
    ...
    parser.add_argument('-c', dest='grid_benchmark_configuration',
                        ...
                        type=str,
                        default="~/w/catkin_ws/src/global_planning_performance_modelling/config/benchmark_configurations/global_planning_grid_benchmark_1.yaml",
                        required=False)
