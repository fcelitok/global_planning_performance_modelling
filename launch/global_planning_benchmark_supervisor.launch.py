...
def generate_launch_description():
    global_planning_benchmark_supervisor_node = Node(
        package='global_planning_performance_modelling',
        executable='global_planning_benchmark_supervisor',
        name='global_planning_benchmark_supervisor',
        output='screen',
        emulate_tty=True,
    ...
    return LaunchDescription([
        ...
        global_planning_benchmark_supervisor_node,
        ...
        RegisterEventHandler(
            event_handler=OnProcessExit(
                target_action=global_planning_benchmark_supervisor_node,
